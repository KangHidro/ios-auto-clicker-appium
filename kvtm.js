...
async function main() {
  ...
  //   parameters: { pointerType: 'touch' },
  //   actions: [
  //     { type: 'pointerMove', duration: 0, x: 265, y: 225 },
  //     { type: 'pointerDown', button: 0 },
  //     { type: 'pointerMove', duration: 100, x: 335, y: 335 },
  ...
  //     parameters: { pointerType: 'touch' },
  //     actions: [
  //       { type: 'pointerMove', duration: 0, x: 450, y: 65 },
  //       { type: 'pointerDown', button: 0 },
  //       { type: 'pointerMove', duration: 250, x: 450, y: 300 },
  //       { type: 'pointerUp', button: 0 },
  //       { type: 'pause', duration: 100 },
  //     ]
  //   }
